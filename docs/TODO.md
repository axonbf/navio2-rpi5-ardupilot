...
| 27 | Propulsion for submerged thrusters (fresh water) | Medium | Roxxy outrunner can't do shaft-out → either treat it for freshwater submersion (stainless/ceramic bearings + potted windings) reusing Roxxy+QuicRun, OR Blue Robotics T200 (~€200 ea, wants 4S, own ESC). Decide when ready. See AGENTS "Propulsion & RPM". |
